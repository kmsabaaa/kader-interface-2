...
export default function GlobalNotFound() {
  return (
    <html lang="en">
      <body className={`${inter.className} bg-[#030303] text-white antialiased selection:bg-amber-500/30 min-h-screen flex flex-col items-center justify-center relative overflow-hidden`}>
        
        {/* INJECTING THE KINETIC CURSOR */}
        <CustomCursor />
        ...
        <div className="relative z-10 text-center flex flex-col items-center max-w-2xl px-6">
          ...
          <h1 className="text-7xl md:text-9xl font-black tracking-tighter mb-4 text-transparent bg-clip-text bg-linear-to-b from-white to-white/20">
            404
          </h1>
          ...
          <Link href="/search" className="inline-flex items-center gap-2 bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-400 hover:to-amber-500 text-black font-bold rounded-xl px-8 py-4 transition-all transform hover:scale-[1.02] active:scale-[0.98] shadow-lg shadow-amber-500/25 cursor-none">
